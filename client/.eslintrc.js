module.exports = {
  ...
  rules: {
    ...
    quotes: ['error', 'single', { allowTemplateLiterals: true, avoidEscape: true }], // specify whether double or single quotes should be used
    ...
    'max-len': 0, //[2, 150, 2], // specify the maximum length of a line in your program (off by default)
