  ...
  return (
    <Section>
      <List>
        ...
        <ListItem>
          <ListItemContent>
            <JobTitle>Frontend Web Developer - NVP Software LLC</JobTitle>
            <Time>Apr 2021 - Present</Time>
            <p>- Frontend for highly-customizable CRM with third-party application integrations</p>
        ...
        <ListItem>
          <ListItemContent>
            ...
            <p>
              - Wrote documentation for school service which makes communication between teachers and schoolchildren's
              parents easier
            </p>
            <p>- Compared existing documentation with actual behavior</p>
            <p>- Created requirements for system</p>
            <p>- Сhecked SQL queries for compliance</p>
          </ListItemContent>
        </ListItem>
      </List>
    </Section>
